...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String QUERY_DAY_OVERVIEW_1 = "select 'Records saved: '|| count(_id) " + DAY_OVERVIEW_KEY_RECORDS + ", strftime(" + DAY_OVERVIEW_FORMAT1 + ",date) " + DAY_OVERVIEW_KEY_DATE + " from GpsProvider group by strftime(" + DAY_OVERVIEW_FORMAT1 + ",date) order by date desc";
    public static final String QUERY_DAY_OVERVIEW_2 = "select 'Records saved: '|| count(_id) " + DAY_OVERVIEW_KEY_RECORDS + ", strftime(" + DAY_OVERVIEW_FORMAT2 + ",date) " + DAY_OVERVIEW_KEY_DATE + " from GpsProvider group by strftime(" + DAY_OVERVIEW_FORMAT2 + ",date) order by date desc";
    public static final String QUERY_DAY_OVERVIEW_3 = "select 'Records saved: '|| count(_id) " + DAY_OVERVIEW_KEY_RECORDS + ", strftime(" + DAY_OVERVIEW_FORMAT3 + ",date) " + DAY_OVERVIEW_KEY_DATE + " from GpsProvider group by strftime(" + DAY_OVERVIEW_FORMAT3 + ",date) order by date desc";
    public static final String QUERY_DAY_OVERVIEW_4 = "select 'Records saved: '|| count(_id) " + DAY_OVERVIEW_KEY_RECORDS + ", strftime(" + DAY_OVERVIEW_FORMAT4 + ",date) " + DAY_OVERVIEW_KEY_DATE + " from GpsProvider group by strftime(" + DAY_OVERVIEW_FORMAT4 + ",date) order by date desc";
